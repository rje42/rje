...
#'   
#' @description Fast but loose implementations of AND and OR logical operators.
#'   
#' @aliases or0
#'   
...
#'   
#' @details Returns pairwise application of logical operators AND and OR. 
#'   Vectors are recycled as usual.
#'   
